 ...
 * @author Neha Ghate
 */
public class SendGroomerRequest extends SendRequests{
    @Override
public JPanel sendRequestPanel(JPanel userProcessContainer, UserAccount account, Organization.Type selectedOrg, Pet selectedPet, WorkRequest request, Enterprise enterprise) {
    return new SendGroomerJPanel(userProcessContainer, request, selectedOrg,selectedPet, account,  enterprise); //To change body of generated methods, choose Tools | Templates.
