...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(Validator.isStringValid(username) && enterprise.getUserAccountDirectory().checkIfUsernameIsUnique(username,system)){
            userName1 = username;
        }
        else
        {
        ...
        for( String error : errorArray )
            ...
            JOptionPane.showMessageDialog(null,message +"are empty fields or duplicate. Please enter the values.","Error ",JOptionPane.ERROR_MESSAGE);   
        }
        else{
             Employee employee = enterprise.getEmployeeDirectory().createEmployee(name1);
            enterprise.getUserAccountDirectory().createUserAccount(userName1, password1, employee, new AdminRole(),emailId1);
