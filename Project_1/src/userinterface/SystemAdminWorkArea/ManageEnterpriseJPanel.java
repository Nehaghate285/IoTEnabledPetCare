...
public class ManageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (Validator.isStringValid(name) && network.getEnterpriseDirectory().checkIfEnterpriseIsUnique(name)) {
            network.getEnterpriseDirectory().createAndAddEnterprise(name, type);
        } else {
            JOptionPane.showMessageDialog(null, "Field is empty or duplicate", "Empty Field", JOptionPane.WARNING_MESSAGE);
