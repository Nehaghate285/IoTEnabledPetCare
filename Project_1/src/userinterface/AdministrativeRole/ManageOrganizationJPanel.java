...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            ...
            {
            if(type.getValue().equals(Type.PetOwner.getValue()))
    ...
    private void initComponents() {
        ...
        organizationJComboBox.setForeground(new java.awt.Color(0, 51, 51));
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if(directory.checkIfOrgIsUnique(type)){
        directory.createOrganization(type);
        }
        else{
            JOptionPane.showMessageDialog(null,"Organization already exixts.Select other one","Duplicate Entry ",JOptionPane.WARNING_MESSAGE);   
        }
        populateTable();
